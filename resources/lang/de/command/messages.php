...
return [
    ...
    'user' => [
        'search_users' => 'Gebe einen Nutzernamen oder eine Mail-Adresse ein.',
        'select_search_user' => 'ID of user to delete (Enter \'0\' to re-search)',
        'deleted' => 'Der Account wurde erfolgreich gelöscht.',
        'confirm_delete' => 'Bist du dir sicher, dass du den Account löschen möchtest?',
